    ...
    >
      <div className="max-w-7xl mx-auto pt-10">
        ...
        <p className="text-gray-400 text-sm md:text-base max-w-sm">
          A quick glimpse into the places I’ve honed my craft, built cool stuff, and vibed with great teams.
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[2px] pointer-events-none"
        >
          <motion.div
            style={{
