...
export default function InnoTrackerPage() {
    useEffect(() => {
            fetch('/api/recent', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    name: 'Project/InnoTracker',
                    path: '/vscode/projects/InnoTracker'
                })
            });
    }, []);
    ...
    return (
        <LampContainer>
            ...
            <div className="mt-[-60] bg-[#0e0e0e] p-6 md:p-10 rounded-xl text-left text-white max-w-4xl mx-auto shadow-2xl space-y-4">
                ...
                <p>
                    Innotracker is a cutting-edge medical assistant platform designed to help patients
                ...
                <div className="flex gap-4 mt-6">
                    <a
                        href="https://github.com/your-repo/mockmate-ai"
                        target="_blank"
                    ...
                    <a
                        href="https://mockmate-ai.vercel.app"
                        target="_blank"
                        rel="noopener noreferrer"
